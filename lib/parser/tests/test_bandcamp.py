...
from bandcamp import _get_album_urls, _normalize, _parse_album, populate_bandcamp_info, search_bandcamp_url
...
class TestPopulateBandcampInfo:
    ...
    @patch("bandcamp.search_bandcamp_url")
    ...
    @patch("bandcamp._parse_album")
    @patch("bandcamp._get_album_urls")
